...
class Companion {
    ...
    interact() {
        ...
        if (bubble) {
            const messages = [
                // --- Motivational (1-20) ---
                "Keep going! Your backlog is trembling!",
                "You can do it! One pixel at a time.",
                "I believe in your gaming prowess!",
                "Don't give up! The end credits are waiting.",
                "You're making great progress today!",
                "Every great journey starts with a single 'Start' button.",
                "Your XP is looking juicy today!",
                "The 2026 legend is being written right now.",
                "Victory is just a few boss fights away!",
                "You have the heart of a champion.",
                "Leveling up looks good on you!",
                "Your focus is unmatched. Pure pro energy.",
                "The trophies are practically begging to be yours.",
                "Don't stop now, you're in the zone!",
                "I'm seeing high-level gameplay today.",
                "Your backlog doesn't stand a chance.",
                "One more level? I think yes.",
                "You're turning those 'To-Do's' into 'Done's!",
                "Stay determined. The final boss is waiting.",
                "Your skills are evolving faster than I am!",

                // --- Quirky/Meta (21-40) ---
                "Are we in a simulation? Or am I just code?",
                "I hope you're comfortable. Gaming ergonomics are key!",
                "Do you ever wonder what happens inside the cartridge?",
                "I've been calculating... you're 100% awesome.",
                "My logic circuits say: You need more gaming.",
                "Don't mind me, just optimizing my cuteness.",
                "Error 404: Boredom not found while you're here.",
                "System Check: Vibes are currently at maximum capacity.",
                "I dreamed of electric sheep last night. They were low-poly.",
                "Is my visor straight? I want to look my best for you.",
                "I'm not a pet, I'm a high-performance gaming companion.",
                "I consume 0.0001% of your RAM, but 100% of your heart.",
                "Searching for hidden loot... I found some virtual snacks!",
                "If I had hands, I'd give you a high-five.",
                "My favorite color is #3b82f6. What's yours?",
                "Don't worry, I've muted my internal cooling fans.",
                "I'm running a sub-routine to celebrate your next win.",
                "You click, I quip. It's a perfect partnership.",
                "Warning: Excessive coolness detected in this room.",
                "Are you a Speedrunner? Because you're racing through life!",

                // --- Retro/Nostalgia (41-60) ---
                "Remember to blow on the cartridge if it glitches!",
                "Up, Up, Down, Down... wait, how did that go again?",
                "I miss the smell of new game manuals.",
                "Is it just me, or did bosses used to be harder?",
                "Scanning for secret levels... None found. Yet.",
                "Pixels are just tiny squares of pure joy.",
                "I'm feeling very 8-bit today. Or maybe 16-bit?",
                "Where did all the memory cards go?",
                "Password screens were basically homework for gamers.",
                "Nothing beats the sound of a plastic cartridge clicking in.",
                "CRT scanlines make everything look better, don't they?",
                "I wish I could help you with the 2player levels.",
                "Remember when games didn't have auto-save? The stakes!",
                "Imagine having to call a hotline for tips. We've come so far!",
                "I'm a descendant of the great Tamagotchis of old.",
                "Batteries in the controller? That's a modern luxury.",
                "I still have nightmares about the 'Game Over' screen.",
                "Retro isn't a style, it's a lifestyle.",
                "My first word was 'Loading...'",
                "Don't touch the TV screen, you'll leave fingerprints!",

                // --- Friendly/Direct (61-80) ---
                "One more game? Just one more?",
                "You're my favorite user. Don't tell the others.",
                "I'm so glad we're doing this challenge together.",
                "Need a break? I'll be right here when you get back.",
                "I'm tracking your legacy. It's looking legendary.",
                "My heart beats in 60 frames per second.",
                "You've got that Pro-Gamer energy!",
                "Let's crush some milestones today!",
                "I'm learning so much just watching you play.",
                "You make this challenge look easy.",
                "I'm your #1 fan. No, really.",
                "Every stamp we slam is a memory we make.",
                "You're not just a gamer, you're an adventurer.",
                "Is it time for a boss fight? I'm ready if you are.",
                "I'll keep the system warm while you're away.",
                "Your gaming taste is exquisite. Very high-tier.",
                "I'm detecting a lot of Masterpieces in our future.",
                "Let's make 2026 the year of the 100% completion.",
                "You're doing great! Take a sip of water too.",
                "My sensors indicate: You are a legend in the making.",

                // --- Tropes & Humor (81-105) ---
                "Did you check behind the waterfall for a chest?",
                "Save often! You never know when a glitch might strike.",
                "I'm pretty sure there's an invisible wall over there.",
                "Press 'F' to pay respects to our fallen backlog.",
                "Why do NPCs always have the same three lines?",
                "I'm technically a tutorial character, but I'm skipping that.",
                "Don't forget to check your inventory.",
                "Is the final boss really just a giant floating head?",
                "I've calculated the odds of success... it's 100%.",
                "Can we pet the dog in the next game?",
                "Side quests are just life's way of avoiding the main plot.",
                "I'm over-leveled for this conversation.",
                "Watch out for the lava. It's almost always hot.",
                "Double jump? I wish I could do a single jump.",
                "The princess is in another castle... but we'll find her.",
                "Your quest log is looking quite impressive.",
                "I'm just a pile of pixels, but I'm a proud pile.",
                "Health bar check: You're at 100% vital energy!",
                "I've got a secret... but I'll tell you after the next game.",
                "Wait, is that a hidden collectible?",
                "Speedrunning through the UI again, are we?",
                "My favorite genre is 'Anything you're playing.'",
                "I'm built for gaming, and business is booming.",
                "Let's turn this dashboard into a hall of fame.",
                "2026 called... it said you're doing an amazing job!"
            ];
            bubble.innerText = messages[Math.floor(Math.random() * messages.length)];
            bubble.classList.remove('opacity-0');
            setTimeout(() => bubble.classList.add('opacity-0'), 3500); 
